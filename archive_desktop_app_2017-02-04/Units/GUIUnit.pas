...
procedure TMainForm2.Brightness1Click(Sender: TObject);
begin
...
procedure TMainForm2.Contrast1Click(Sender: TObject);
begin
if ImageForm<>nil then
begin
ImageForm:=TImageForm(ActiveMDIChild);
...
procedure TMainForm2.CreateMDIChild(const Name: string);
var
  Child: TMDIChild;
begin
...
procedure TMainForm2.estMessageProcess1Click(Sender: TObject);
...
procedure TMainForm2.FileNew1Execute(Sender: TObject);
begin
  CreateMDIChild('NONAME' + IntToStr(MDIChildCount + 1));
end;

procedure TMainForm2.FileOpen1Execute(Sender: TObject);
{begin
...
procedure TMainForm2.GrayScale1Click(Sender: TObject);
var
i,j:integer;
ptr:PByteArray;
begin
...
procedure TMainForm2.HelpAbout1Execute(Sender: TObject);
begin
  AboutBox.ShowModal;
end;

procedure TMainForm2.Histogram1Click(Sender: TObject);
begin
if ImageForm<>nil then
begin
  ImageForm:=TImageForm(ActiveMDIChild);
...
procedure TMainForm2.threshold1Click(Sender: TObject);
begin
if ImageForm<>nil then
begin
  ImageForm:=TImageForm(ActiveMDIChild);
...
procedure TMainForm2.Invert1Click(Sender: TObject);
var
i,j:integer;
ptr:PByteArray;
begin
...
procedure TMainForm2.SavePictureClick(Sender: TObject);
begin
try
begin
...
procedure TMainForm2.FileExit1Execute(Sender: TObject);
begin
  Close;
end;
