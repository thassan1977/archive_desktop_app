...
uses
  ...
  JazDBGrid, ExtCtrls, ActnList, AmjactionsU, Mask, DBCtrls;
...
type
  ...
  TTemplateForm = class(TForm)
    ...
    procedure MasterSetBeforePost(DataSet: TDataSet);
    procedure jqDOCSAfterPost(DataSet: TDataSet);
  private
    { Private declarations }
  public
    { Public declarations }
    DBEDITARR : ARRAY OF TDBEDIT;
...
DetailSet.params.paramByName('pid').AsString := MasterSet.FieldByName('id').AsString;
 ...
 procedure TTemplateForm.jqDOCSAfterPost(DataSet: TDataSet);
begin
jqDOCS.EDIT;
end;
...
procedure TTemplateForm.MasterSetBeforePost(DataSet: TDataSet);
begin
jqdocs.post;
end;
