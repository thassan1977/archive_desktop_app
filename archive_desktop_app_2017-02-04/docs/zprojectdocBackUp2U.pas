...
type
  TzprojectdocBackUp2f = class(TJPmain)
    Panel1: TPanel;
...
procedure TzprojectdocBackUp2f.d1Click(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomPercent := ImageScrollBox.ZoomPercent + 10;
end;
procedure TzprojectdocBackUp2f.docjqAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.docjqBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.EditFilePictHandle(Sender: TObject;
...
procedure TzprojectdocBackUp2f.EditFolderHandle(Sender: TObject;
  var IsFailed: Boolean; var ErrorMsg: string);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.editHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
 var str :string;
  s : TMemoryStream;
  I : integer;
...
procedure TzprojectdocBackUp2f.EditPictHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
begin
  inherited;
  EditImageForm := TEditImageForm.create(self);
...
procedure TzprojectdocBackUp2f.Load_Doc;
var
    s: TMemoryStream;
begin
...
procedure TzprojectdocBackUp2f.OnProgress( const Sender          : TObject;
                                const PercentProgress : Byte );
begin
...
procedure TzprojectdocBackUp2f.SaveAsMenuClick(Sender: TObject);
var
...
procedure TzprojectdocBackUp2f.SaveMenuClick(Sender: TObject);
begin
...
procedure TzprojectdocBackUp2f.saveToDB(pNew:Boolean);
var
    FromStream: TStream;
    jadoset : TADODataSet;
begin
...
procedure TzprojectdocBackUp2f.saveToDB2(pNew:Boolean);
var
    FromStream: TStream;
    jadoset : TADODataSet;
begin
...
procedure TzprojectdocBackUp2f.LoadFile( const FileName : String );
var
    MultiLoad : Boolean;
...
procedure TzprojectdocBackUp2f.LoadFile2( const FileName : String );
var
    MultiLoad : Boolean;
...
procedure TzprojectdocBackUp2f.ZoomEditChange(Sender: TObject);
begin
    try
...
procedure TzprojectdocBackUp2f.zprojectFind(Sender: TObject; ID: string);
begin
  inherited;
jq.close;
jq.open;
...
procedure TzprojectdocBackUp2f.OnAcquire( const DibHandle    : THandle;
                               const XDpi         : Word;
                               const YDpi         : Word;
                               const CallBackData : LongInt );
var
...
Procedure TzprojectdocBackUp2f.FInit;
Begin
  PCaption := 'ÊÀ«∆ﬁ «·„‘—Ê⁄';
  //JQ.AfterScroll := nil;
...
End;
procedure TzprojectdocBackUp2f.ImageNewactHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
Var pt: TPoint;
begin
  inherited;
...
procedure TzprojectdocBackUp2f.ImageOpActHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
  Var pt: TPoint;
begin
  inherited;
...
procedure TzprojectdocBackUp2f.ImageViewActHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
  Var pt: TPoint;
begin
  inherited;
...
procedure TzprojectdocBackUp2f.Scan_Pict(Pmulti:Boolean);
var
    SaveDialog  : TSaveDialog;
    ScanInfo    : TScanInfo;
    FileName    : String;
...
procedure TzprojectdocBackUp2f.jq2AfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.jq2AfterScroll(DataSet: TDataSet);
begin
  inherited;
{  jq3.close;
  jq3.open;
...
procedure TzprojectdocBackUp2f.jq2BeforeInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.jq2BeforeOpen(DataSet: TDataSet);
begin
  inherited;
  jq2.Params.ParamByName('pid').asstring := jq.fieldbyname('id').asstring;
end;

procedure TzprojectdocBackUp2f.jq3AfterInsert(DataSet: TDataSet);
begin
  inherited;
  jq3.edit;
...
procedure TzprojectdocBackUp2f.jq3AfterOpen(DataSet: TDataSet);
begin
  inherited;
//   Load_Doc;
end;

procedure TzprojectdocBackUp2f.jq3AfterScroll(DataSet: TDataSet);
begin
  inherited;
//   Load_Doc;
end;

procedure TzprojectdocBackUp2f.jq3BeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.JQAfterInsert(DataSet: TDataSet);
begin
  inherited;
///////// 05/06/2016
...
procedure TzprojectdocBackUp2f.JQAfterScroll(DataSet: TDataSet);
begin
  inherited;
jq2.close;
jq2.open;
...
procedure TzprojectdocBackUp2f.JQBeforeInsert(DataSet: TDataSet);
begin
  inherited;
//if zproject.text = '' then abort;
end;

procedure TzprojectdocBackUp2f.JQBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.JQFoldersAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.JQFoldersAfterScroll(DataSet: TDataSet);
begin
  inherited;
jq3.close;
jq3.open;
...
procedure TzprojectdocBackUp2f.JQFoldersBeforeOpen(DataSet: TDataSet);
begin
  inherited;
JQFolders.params.paramByName('pid').AsString := jq2.FieldByName('id').AsString;
end;

procedure TzprojectdocBackUp2f.N10Click(Sender: TObject);
begin
  inherited;
SaveAsMenuClick(sender);
end;

procedure TzprojectdocBackUp2f.N12Click(Sender: TObject);
var
...
procedure TzprojectdocBackUp2f.N13Click(Sender: TObject);
var
...
procedure TzprojectdocBackUp2f.N15Click(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomPercent := ImageScrollBox.ZoomPercent - 10;
end;

procedure TzprojectdocBackUp2f.N1Click(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomMode := zmOriginalSize;
end;

procedure TzprojectdocBackUp2f.N2Click(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomMode := zmFullPage;
end;

procedure TzprojectdocBackUp2f.N3Click(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomMode := zmFitWidth;
end;

procedure TzprojectdocBackUp2f.N4Click(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomMode := zmFitHeight;
end;

procedure TzprojectdocBackUp2f.N5Click(Sender: TObject);
begin
  inherited;
if not Scanner.IsConfigured then
    begin
...
procedure TzprojectdocBackUp2f.N7Click(Sender: TObject);
begin
  inherited;
Scan_Pict(false);
end;

procedure TzprojectdocBackUp2f.N8Click(Sender: TObject);
begin
  inherited;
 Scan_Pict(true);
end;

procedure TzprojectdocBackUp2f.N9Click(Sender: TObject);
var
...
procedure TzprojectdocBackUp2f.NewFolderHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.newHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
  var str :string;
  s : TMemoryStream;
  I : integer;
...
jq2.post; //}  // jq2.FieldByName('id').AsString or 's'
 ...
 procedure TzprojectdocBackUp2f.PrivShowHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.ProcessJson( JsonForm :TTemplateForm;txt: String);
...
//  position_s,position_E :integer;
 ...
 // DataSet1 : Tamjset;
  ...
  LABEL12,LABEL13,LABEL14 :TLABEL;
///
...
{   if PropertiesObj['Color'] <> '' then} labeL12.font.color :=clWindowText;//.font.color := StringTocolor('cl' + PropertiesObj['Color']);
   ...
   DBEDITARR[HIGH(DBEDITARR)].Left :=  labeL12.Left - 30 - DBEdit2.width;
   DBEDITARR[HIGH(DBEDITARR)].Top :=  labeL12.Top;
...
//   panel1.align := altop;
  ...
  procedure TzprojectdocBackUp2f.ProcessJsonNm( JsonForm :TTemplateForm;txt: String);
  var str,TableName:string;  // text to be modified
//  JsonForm : TTemplateForm;
  lab : Tlabel;
//  position_s,position_E :integer;
...
procedure TzprojectdocBackUp2f.qDOCFILESAfterInsert(DataSet: TDataSet);
begin
  inherited;
  qDOCFILES.edit;
...
procedure TzprojectdocBackUp2f.qDOCFILESAfterOpen(DataSet: TDataSet);
begin
  inherited;
Load_Doc;
end;

procedure TzprojectdocBackUp2f.qDOCFILESAfterScroll(DataSet: TDataSet);
begin
  inherited;
   Load_Doc;
end;

procedure TzprojectdocBackUp2f.qDOCFILESBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TzprojectdocBackUp2f.AddPictAction2Handle(Sender: TObject;
  var IsFailed: Boolean; var ErrorMsg: string);
var
    OpenDialog   : TOpenPictureDialog;
    s1,s2,s3 : string;
...
procedure TzprojectdocBackUp2f.AddSunHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
...
procedure TzprojectdocBackUp2f.AmjSet1BeforeOpen(DataSet: TDataSet);
begin
  inherited;
  AmjSet1.Params.ParamByName('pid').asstring := jq2.fieldbyname('id').asstring;
end;

procedure TzprojectdocBackUp2f.CheckDirty;
begin
...
procedure TzprojectdocBackUp2f.NameAndWidthColumn(dbgrid:tjazdbgrid;fieldn,newname:string;widthn:integer);
  var i:integer;
begin
