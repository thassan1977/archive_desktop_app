inherited zprojectdocsf: Tzprojectdocsf
  ...
  object AmjSet1: TAmjSet
    ...
    CommandText = 
      ...
      'INK, FILEFORMAT, VIEWCO,'#13#10'   DOWNLOADCO, ISDELETED, ISACTIVE,'#13#10' ' +
      ' JCRT_USER,JCRT_DAT, JUPDT_USER, JUPDT_DAT'#13#10'FROM JDMS.JPROJ_DOCS' +
      '_FILES_VERSION'#13#10'WHERE JDMS.JPROJ_DOCS_FILES_VERSION.FILEID=:pid'#13 +
      #10
    Params = <
      item
        DataType = ftUnknown
  ...
  object FolderAction: TAmjActionList
    ...
    object FolderUpdateFile: TAction
      Category = 'amwajSTD'
      Caption = #1578#1576#1583#1610#1604' '#1605#1581#1578#1608#1609' '#1575#1604#1605#1604#1601
      ImageIndex = 12
      OnExecute = FolderUpdateFileExecute
    end
    object actnAddFolder: TAction
      Category = 'amwajSTD'
      Caption = #1573#1590#1575#1601#1577' '#1605#1580#1604#1583' '#1580#1583#1610#1583
      OnExecute = actnAddFolderExecute
    end
  end
  ...
  object ImageList1: TImageList
    ...
    Top = 181
    Bitmap = {
      494C01011D002200840010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
