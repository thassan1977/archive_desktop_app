...
uses
  ...
  JPMainU, AmjLookUpU, AmjactionsU, DemoForm,
...
uses JAppMainU, AmjBtnU,
   ...
   // About,    { for TAboutBox }
    ...
    EnReg    { for image format registration }, ImagEditor;



{$R *.dfm}

Procedure TImgIdtf.PreFInit;
...
procedure TImgIdtf.sbLineClick(Sender: TObject);
var
...
procedure TImgIdtf.SetDrawingStyle;
...
begin
 ...
 with ImageScrollBox.FImage do
  ...
  END;
END;
procedure TImgIdtf.DrawToImage(TL, BR: TPoint; PenMode: TPenMode);
...
procedure TImgIdtf.ImageColorHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
  Var pt: TPoint;
begin
  inherited;
...
procedure TImgIdtf.ImageOpHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
  Var pt: TPoint;
begin
  inherited;
...
procedure TImgIdtf.ImageScrollBoxBeforeSave(const Sender: TImageScrollBox;
  const Graphic: TDibGraphic);
begin
  inherited;
...
procedure TImgIdtf.ImageScrollBoxDblClick(Sender: TObject);
VAR
...
procedure TImgIdtf.ImageScrollBoxImageClick(Sender: TObject);
VAR
    InBmp, CroppedBmp, SizedBmp : TBitmap;////22/03/2016
    FromStream: TStream; ////22/03/2016
    ///
...
procedure TImgIdtf.ImageScrollBoxImageMouseMove(Sender: TObject;
...
procedure TImgIdtf.ImageScrollBoxQuickSelect(const Sender: TImageScrollBox;
  const Graphic: TDibGraphic; const Rect: TRect);
begin
  inherited;
...
procedure TImgIdtf.ImageScrollBoxRedraw(const Graphic: TDibGraphic);
begin
  inherited;
...
procedure TImgIdtf.ImageScrollBoxRubberbandChange(const Rect: TRect);
begin
  inherited;
...
procedure TImgIdtf.ImageScrollBoxZoomChange(const Sender: TImageScrollBox;
  const Zoom: Single);
begin
  inherited;
...
procedure TImgIdtf.JQAfterInsert(DataSet: TDataSet);
begin
  inherited;
jq.fieldbyname('id').asstring:=Japp.DB.Get_maxSeq('jedms.DOC_FILE_ANNOTATION');
end;

procedure TImgIdtf.JQBeforeOpen(DataSet: TDataSet);
begin
  inherited;
...
procedure TImgIdtf.PageEditChange(Sender: TObject);
var
    FrameNo   : LongInt;
...
procedure TImgIdtf.RB1Click(Sender: TObject);
begin
  inherited;
...
procedure TImgIdtf.save1Click(Sender: TObject);
begin
  inherited;
...
procedure TImgIdtf.saveas1Click(Sender: TObject);
var
    SaveDialog  : TSaveDialog;
begin
  inherited;
...
procedure TImgIdtf.sbRectSelectClick(Sender: TObject);
begin
  inherited;
 // First erase the cliprect if current drawing type
  if DrawType = dtClipRect then
...
procedure TImgIdtf.undoHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
begin
  inherited;
...
procedure TImgIdtf.ViewImageHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
  Var pt: TPoint;
begin
  inherited;
...
procedure TImgIdtf.ZoomEditChange(Sender: TObject);
begin
  inherited;
{  try
...
procedure TImgIdtf.FitHeightMenuClick(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomMode := zmFitHeight;
end;

procedure TImgIdtf.FitToPageMenuClick(Sender: TObject);
begin
  inherited;
...
procedure TImgIdtf.FrameDblClick(Sender: TObject);
begin
  inherited;
MouseImgX := MouseImgX;
MouseImgY := MouseImgY;
...
procedure TImgIdtf.FullPageMenuClick(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomMode := zmFullPage;
end;
procedure TImgIdtf.setAnnotationClick(Sender: TObject);
...
procedure TImgIdtf.getAnnotationClick(Sender: TObject);
var result:AnsiString;
  var
  myFile : TextFile;
  var
...
procedure TImgIdtf.ActualSizeMenuClick(Sender: TObject);
begin
  inherited;
ImageScrollBox.ZoomMode := zmOriginalSize;
end;

procedure TImgIdtf.AddImageClick(Sender: TObject);
begin
  inherited;
ImageScrollBox.MouseMode := mmAnnotate;
...
procedure TImgIdtf.AddLineClick(Sender: TObject);
begin
  inherited;
ImageScrollBox.MouseMode := mmAnnotate;
...
procedure TImgIdtf.AddNoteClick(Sender: TObject);
begin
  inherited;
ImageScrollBox.MouseMode := mmAnnotate;
...
procedure TImgIdtf.AddRectangleClick(Sender: TObject);
begin
  inherited;
ImageScrollBox.MouseMode := mmAnnotate;
...
procedure TImgIdtf.AddTextClick(Sender: TObject);
begin
  inherited;
ImageScrollBox.MouseMode := mmAnnotate;
...
procedure TImgIdtf.AddWatermarkClick(Sender: TObject);
  var
...
procedure TImgIdtf.openFileHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
  Var pt: TPoint;
begin
  inherited;
...
procedure TImgIdtf.open1Click(Sender: TObject);
...
procedure TImgIdtf.AppendtoDCXMenuHandle(Sender: TObject;
...
procedure TImgIdtf.cgDrawingColorsChange(Sender: TObject);
begin
  inherited;
...
procedure TImgIdtf.EditImageHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
  Var pt: TPoint;
begin
  inherited;
...
procedure TImgIdtf.EnvisionFormHandle(Sender: TObject; var IsFailed: Boolean;
  var ErrorMsg: string);
begin
  inherited;
...
procedure TImgIdtf.LoadFile( const FileName : String );
var
    MultiLoad : Boolean;
    InBmp, CroppedBmp, SizedBmp : TBitmap;////22/03/2016
    FromStream: TStream; ////22/03/2016
...
procedure TImgIdtf.N22Click(Sender: TObject);
var
