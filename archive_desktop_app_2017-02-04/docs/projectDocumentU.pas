...
Begin
  if jq.recordcount > 0 then
    if jq.fieldbyname('typ').asstring = '⁄ﬁœ' then begin
      str := '—ﬁ„ «·⁄ﬁœ: ' + jq.fieldbyname('CTRCT_NO').asstring;
      str := str + '   «—ÌŒ «·⁄ﬁœ: ' + jq.fieldbyname('CTRCT_SDAT').asstring;
      str := str + '  ﬁÌ„… «·⁄ﬁœ: ' + jq.fieldbyname('VALTOT').asstring;
      str := str + '  „œ… «·⁄ﬁœ: ' + jq.fieldbyname('PERIODTOT').asstring;
      if JMainPages.activePage = BillTS then begin
        ...
        str := str + '  ﬁÌ„… ««·ﬂ‘Ê›: ' + qtot.fieldbyname('VAL').asstring;
      end
      ...
      str := '—ﬁ„ «·ÿ·»: ' + jq.fieldbyname('CTRCT_NO').asstring;
//      str := str + '   «—ÌŒ «·ÿ·»: ' + jq.fieldbyname('REQ_DAT').asstring;
//      str := str + '  ﬁÌ„… «·⁄ﬁœ: ' + jq.fieldbyname('VALTOT').asstring;
//      str := str + '  „œ… «·⁄ﬁœ: ' + jq.fieldbyname('PERIODTOT').asstring;
      if JMainPages.activePage = BillTS then begin
{        qtot.close;
     ...
     //   str := str + '  ﬁÌ„… «·›Ê« Ì—: ' + qtot.fieldbyname('VAL').asstring;
      end
      else if JMainPages.activePage = SulafTS then begin
